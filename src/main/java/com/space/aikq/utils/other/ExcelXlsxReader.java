...
import static cn.hutool.poi.excel.sax.ExcelSaxUtil.countNullCell;

/**
 * @description
 * @author aikq
 * @date 2018年10月26日 8:54
 */
public class ExcelXlsxReader extends DefaultHandler {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("**********************************************");
			ExcelReaderUtil.readExcel(rowReader, "C:\\Users\\Administrator\\Desktop\\上网人员上网记录20181019101353.xlsx");
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
